...
void multi_source_Dijkstra(int numFrom, int *fromNode, int vertexs, int edges, int *rowOffsetArc, int *colValueArc, float *weightArc, float *shortLenTable)
{
    int numberOfBlock;
    //在GPU中分配空间
    float *d_weightRow;
...
void handle_boundry_AMD_GPU(float *subGraph, int vertexs, int edges, int bdy_num,
